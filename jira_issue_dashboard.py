...
st.set_page_config(page_title="Issue Tracker (Jira)", page_icon="📋",
...
.rep-row{background:#fff;border:1px solid #e2e8f0;border-radius:13px;
  ...
  grid-template-columns:180px 70px 150px 150px 90px 90px 90px 1fr;
...
TI = {"Bug":"🐛","Improvement":"⬆️","Task":"✅","Epic":"⚡",
...
# ════════════════════════════════════════════════════════════════
type_stats = "".join(
    f'<span class="bstat">{TI.get(t,"")} {t}: {int(df["issue_type"].eq(t).sum())}</span>'
    for t in sorted(df["issue_type"].dropna().unique())
)
st.markdown(f"""
<div class="banner">
  ...
  <div style="margin-top:12px;">{type_stats}</div>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div style="display:grid;grid-template-columns:180px 70px 150px 150px 90px 90px 90px 1fr;
...
# ════════════════════════════════════════════════════════════════
# SECTION 2 — Bug vs Improvement breakdown
# ════════════════════════════════════════════════════════════════
st.markdown('<div class="wcard">', unsafe_allow_html=True)
...
with t2:
    ...
    for col_obj, field, label, color, icon in [
        ...
        with col_obj:
            ...
            """, unsafe_allow_html=True)
            for _, r in rep_df.sort_values(field, ascending=False).iterrows():
...
# ════════════════════════════════════════════════════════════════
# SECTION 3 — Status Distribution per Reporter
# ════════════════════════════════════════════════════════════════
st.markdown('<div class="wcard">', unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════════
# SECTION 4 — Priority Distribution per Reporter
# ════════════════════════════════════════════════════════════════
st.markdown('<div class="wcard">', unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════════
# SECTION 5 — Monthly Trend (Top 5 Reporters)
# ════════════════════════════════════════════════════════════════
st.markdown('<div class="wcard">', unsafe_allow_html=True)
